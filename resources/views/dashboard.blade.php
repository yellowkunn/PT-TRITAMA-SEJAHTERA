...
<body class="font-bold">
        ...
        <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Our Team</a>
                    </li>
                    <li>
                        <a href="#"
    ...
    {{-- konten 1 --}}
    <div class="w-full h-[93vh] relative overflow-hidden">
        ...
        <div class="relative z-10 w-full h-full flex items-center justify-start pl-40 pr-4">
            ...
            <div class="max-w-xl p-6 ">
                <div class="inline-block mb-6">
                    ...
                    <div class="h-0.5 bg-yellow-400 rounded-full"></div>
                  </div>
                  
                <a href="#">
                    <h5 class="mb-2 text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">Palm Oil Industry Commitment To Sustainbility</h5>
                </a>
                <p class="mb-3 font-normal text-gray-200 dark:text-gray-200">Palm oil and its derivatives are commonly found in personal care and cosmetic products. They provide stability, texture, and moisturizing properties to items like soaps, shampoos, lotions, and makeup.</p>
                <a href="#" class="inline-flex items-center gap-2 px-3 py-1.5 bg-yellow-400 dark:text-black rounded-md font-medium no-underline hover:bg-yellow-300">
                    Products
                    <svg class="w-4 h-4 dark:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="bg-red-500 rounded-lg shadow-xl min-h-[100px]"></div>
        <div class="bg-blue-500 rounded-lg shadow-xl min-h-[100px]"></div>
    </div>
        ...
        <div class="relative z-10 w-full h-full flex items-center justify-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <div
                    ...
                    <a href="#">
                        <img class="rounded-t-lg h-40 w-full object-cover"
                            src="https://i.pinimg.com/474x/eb/30/d7/eb30d7a8d3fb60c409da372e777e991a.jpg"
                            alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                ...
                <div
                    ...
                    <a href="#">
                        <img class="rounded-t-lg h-40 w-full object-cover"
                            src="https://i.pinimg.com/474x/87/da/ab/87daab35bf074f948f0f09840638485f.jpg"
                            alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
