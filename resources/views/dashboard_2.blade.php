    ...
    <div class="px-4">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:flex md:items-center md:gap-5 mx-auto">
                <a href="#" class="px-2 py-1 text-sm font-medium text-gray-900 hover:bg-white/30 rounded-lg">Home</a>
                <a href="#" class="px-2 py-1 text-sm font-medium text-gray-900 hover:bg-white/30 rounded-lg">Company</a>
                <a href="#" class="px-2 py-1 text-sm font-medium text-gray-900 hover:bg-white/30 rounded-lg">Product</a>
                <a href="#" class="px-2 py-1 text-sm font-medium text-gray-900 hover:bg-white/30 rounded-lg">Our team</a>
                <a href="#" class="px-2 py-1 text-sm font-medium text-gray-900 hover:bg-white/30 rounded-lg">Contact Us</a>
            </div>
        </div>
        ...
        <div id="mobile-menu" class="mt-3 hidden flex-col space-y-2 md:hidden">
            ...
            <a href="#" class="block px-4 py-2 text-sm text-gray-900 rounded-lg hover:bg-gray-100">Product</a>
            <a href="#" class="block px-4 py-2 text-sm text-gray-900 rounded-lg hover:bg-gray-100">Our team</a>
            <a href="#" class="block px-4 py-2 text-sm text-gray-900 rounded-lg hover:bg-gray-100">Contact Us</a>
        </div>
    </div>
